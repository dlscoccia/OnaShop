...
export const initialData: SeedData = {
  ...
  products: [
    ...
    {
      description:
        'Relaxed-fit shirt in a woven linen and cotton blend. Resort collar, buttons without placket, and yoke at back. Open chest pocket, short sleeves, and straight-cut hem.',
      images: ['1740250-00-A_0_2000.jpg', '1740250-00-A_1.webp'],
      inStock: 10,
      price: 130,
      sizes: ['S', 'M', 'L', 'XL', 'XXL'],
      ...
      type: 'shirts',
      tags: ['shirt'],
      title: 'Relaxed Fit Linen-blend Resort Shirt',
      gender: 'men',
    },
